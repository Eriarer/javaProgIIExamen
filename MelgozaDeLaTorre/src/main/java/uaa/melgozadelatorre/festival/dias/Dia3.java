...
public class Dia3 extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel titulo = new javax.swing.JLabel("DIA 3");
        ...
        JLabel fecha = new JLabel("Fecha de inicio: 17 de mayo");
        ...
        JLabel duracion = new JLabel("Duracion: 6 horas");
        ...
        JTextArea descripcionGeneral = new JTextArea(
                "El tercer día del festival se llevará a cabo en el escenario principal, en el cual se realizara la despedia con un concurso de bandas y solistas, tambien se presentara un invidato especial , el cual sera un miestrio miesterioso (me quede sin ideas) y se presentaran los ganadores de los concursos de bandas y solistas.");
