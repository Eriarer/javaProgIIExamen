...
public class Dia1 extends JPanel {
    public Dia1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JLabel titulo = new javax.swing.JLabel("DIA 1");
        ...
        JLabel duracion = new JLabel("Duración: 4 horas");
        ...
        JTextArea texto = new JTextArea(
                "El primer día del festival se llevará a cabo la inauguración del mismo, en la cual se presentarán los artistas invitados, se dará a conocer el programa del festival y se realizará la presentación de los artistas que participarán en el festival.");
